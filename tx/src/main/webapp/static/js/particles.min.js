...
var pJS = function (e, a) {
    ...
    a && Object.deepExtend(i, a), i.tmp.obj = {
        ...
        var e = this;
        if (void 0 != e.radius_bubble) var a = e.radius_bubble; else var a = e.radius;
        if (void 0 != e.opacity_bubble) var t = e.opacity_bubble; else var t = e.opacity;
        if (e.color.rgb) var s = "rgba(" + e.color.rgb.r + "," + e.color.rgb.g + "," + e.color.rgb.b + "," + t + ")"; else var s = "hsla(" + e.color.hsl.h + "," + e.color.hsl.s + "%," + e.color.hsl.l + "%," + t + ")";
        switch (i.canvas.ctx.fillStyle = s, i.canvas.ctx.beginPath(), e.shape) {
            ...
            case"star":
                ...
                break;
            case"image":
                if ("svg" == i.tmp.img_type) var n = e.img.obj; else var n = i.tmp.img_obj;
                n && function () {
                    i.canvas.ctx.drawImage(n, e.x - a, e.y - a, 2 * a, 2 * a / e.img.ratio)
                }()
        }
        ...
        e.radius + a.radius >= s && (e.vx = -e.vx, e.vy = -e.vy, a.vx = -a.vx, a.vy = -a.vy)
        ...
        if (i.interactivity.events.onhover.enable && isInArray("repulse", i.interactivity.events.onhover.mode) && "mousemove" == i.interactivity.status) {
            var a = e.x - i.interactivity.mouse.pos_x, t = e.y - i.interactivity.mouse.pos_y,
                s = Math.sqrt(a * a + t * t), n = {x: a / s, y: t / s}, r = i.interactivity.modes.repulse.distance,
        ...
        } else if (i.interactivity.events.onclick.enable && isInArray("repulse", i.interactivity.events.onclick.mode)) if (i.tmp.repulse_finish || ++i.tmp.repulse_count == i.particles.array.length && (i.tmp.repulse_finish = !0), i.tmp.repulse_clicking) {
        ...
        var a = i.tmp.source_svg, t = a.replace(/#([0-9A-F]{3,6})/gi, function (a, t, i, s) {
                ...
                return n
            }), s = new Blob([t], {type: "image/svg+xml;charset=utf-8"}), n = window.URL || window.webkitURL || window,
            r = n.createObjectURL(s), c = new Image;
